...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreffixRewrite) DeepCopyInto(out *PreffixRewrite) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreffixRewrite.
func (in *PreffixRewrite) DeepCopy() *PreffixRewrite {
	if in == nil {
		return nil
	}
	out := new(PreffixRewrite)
	in.DeepCopyInto(out)
	return out
}
