...
// // Service buffers access logs from the remote Envoy nodes.
// type Service struct {
// 	entries []string
// 	mu      sync.Mutex
// }

// func (svc *Service) log(entry string) {
// 	svc.mu.Lock()
// 	defer svc.mu.Unlock()
...
// func (svc *Service) Dump(f func(string)) {
// 	svc.mu.Lock()
// 	defer svc.mu.Unlock()
...
// func (svc *Service) StreamAccessLogs(stream als.AccessLogService_StreamAccessLogsServer) error {
// 	var logName string
// 	for {
// 		msg, err := stream.Recv()
// 		if err != nil {
